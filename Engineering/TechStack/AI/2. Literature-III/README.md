...
This repository contains resources for deeper study:
...
- **[Bishop Pattern Recognition and Machine Learning](./Bishop-Pattern-Recognition-and-Machine-Learning-2006.pdf)**: Comprehensive textbook by Christopher Bishop covering probabilistic approaches to pattern recognition and machine learning, including Bayesian methods, neural networks, and various ML algorithms with a strong theoretical foundation.
